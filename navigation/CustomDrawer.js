...
const CustomDrawer = ({ selectedTab, setSelectedTab }) => {
    ...
    const [progess, setProgress] = React.useState(new Animated.Value(0))

    const scale = Animated.interpolateNode(progess, {
        inputRange: [0, 1],
        outputRange: [1, 0.8]
    })

    const borderRadius = Animated.interpolateNode(progess, {
        inputRange: [0, 1],
        outputRange: [0, 26]
    })
    ...
    return (
        ...
        >
            <Drawer.Navigator
                ...
                sceneContainerStyle={{
                    backgroundColor: 'transparent' //your screen will be transparent
                }}
                initialRouteName='MainLayout'
                drawerContent={props => {

                    setTimeout(() => { // to prevent error, use timeout function to wrap
